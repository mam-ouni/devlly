        ...
        <div className="sec-lg-head section-padding">
          <div className="row ontop">
            <div className="col-11 d-flex align-items-center">
              <div>
                <h6 className="sub-title">{t('product page.call to action.title')}</h6>
                <h2 className="fz-50 d-rotate wow">
                  <span className="rotate-text">{t('product page.call to action.sub title')}</span>
                </h2>
              </div>
              <div className="ml-auto">
                <Link href="/dark/project-details1" className="butn-circle d-flex align-items-center text-center m-auto">
                  <div className="full-width">
                    ...
                    <span className="full-width">{t('product page.call to action.button')}</span>
                  </div>
