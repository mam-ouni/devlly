            ...
            <div className="col-11 d-flex align-items-center">
              <div className="valign">
                <h2 className="fz-50 d-rotate wow">
                  <span className="rotate-text"> {t('about page.call to action.title.one')} </span>
                  <span className="rotate-text">{t('about page.call to action.title.two')} <span className={innerPageStyle ? '' : 'sub-font'}>{t('about page.call to action.title.three')}</span>.</span>
                </h2>
              </div>
              <div className="ml-auto">
                <Link href="/dark/page-contact" className="butn-circle d-flex align-items-center text-center m-auto">
                  <div className="full-width">
                    ...
                    <span className="full-width">{t('about page.call to action.button')}</span>
                  </div>
