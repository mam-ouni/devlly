        ...
        <div className="row justify-content-center">
          <div className="col-lg-10">
            <div className="sec-lg-head text-center">
              <h6 className="dot-titl mb-10">{t('home page.hzscroll.call to action.titre')}</h6>
              <h2 className="fz-70 fw-700">
                <span>{t('home page.hzscroll.call to action.titre2.one')}</span>
                <br />
                <span>{t('home page.hzscroll.call to action.titre2.two')}</span>
              </h2>
              <Link href={`/${lightMode ? 'light' : 'dark'}/page-contact`}
                ...
                <div className="full-width">
                  ...
                  <span className="full-width">{t('home page.hzscroll.call to action.button')}</span>
                </div>
